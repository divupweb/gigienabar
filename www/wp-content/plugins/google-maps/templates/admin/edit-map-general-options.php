...
<li class="editing_section ">
	<div class="editing_heading">
		...
		<?php _e( 'General Options', 'hugeit_maps' ); ?>
		<div class="help">?
			<div class="help-block">
				<span class="pnt"></span>
				<p><?php _e( 'General Options of current map', 'hugeit_maps' ); ?></p>
			</div>
		</div>
	...
	<div class="edit_content map_options hide">
		<form action="" method="post">
			<ul>
				<li>
					<label for="map_name"><?php _e( 'Map Name', 'hugeit_maps' ); ?></label>
					<input type="text" name="map_name" id="map_name" value="<?php echo $map->get_name(); ?>"/>
				</li>
				<li>
					<label for="map_controller_pan"><?php _e( 'Enable Pan-Controller', 'hugeit_maps' ); ?></label>
				...
				<li>
					<label for="map_controller_zoom"><?php _e( 'Enable Zoom-Controller', 'hugeit_maps' ); ?></label>
				...
				<li>
					<label for="map_controller_type"><?php _e( 'Enable Map-Type-Controller', 'hugeit_maps' ); ?></label>
				...
				<li>
					<label for="map_controller_scale"><?php _e( 'Enable Scale-Controller', 'hugeit_maps' ); ?></label>
				...
				<li>
					<label for="map_controller_street_view"><?php _e( 'Enable Street-View-Controlle', 'hugeit_maps' ); ?>r</label>
				...
				<li>
					<label for="map_controller_overview"><?php _e( 'Enable Overview-Map-Controller', 'hugeit_maps' ); ?></label>
				...
				<li>
					<label for="map_zoom"><?php _e( 'Default Zoom', 'hugeit_maps' ); ?></label>
				...
				<li>
					<label for="min_zoom"><?php _e( 'Minimum Zoom', 'hugeit_maps' ); ?></label>
					<div class="slider-container" style="float:left; width:55%; height:25px; ">
				...
				<li>
					<label for="max_zoom"><?php _e( 'Maximum Zoom', 'hugeit_maps' ); ?></label>
					<div class="slider-container" style="float:left; width:55%; height:25px; ">
				...
				<li>
					<label for="map_center_addr"><?php _e( 'Center Address', 'hugeit_maps' ); ?></label>
					<input type="text" name="map_center_addr" id="map_center_addr"/>
				</li>
				<li>
					<label for="map_center_lat"><?php _e( 'Center Latitude', 'hugeit_maps' ); ?></label>
					<input type="text" name="map_center_lat" id="map_center_lat" value="<?php echo $map->get_center_lat(); ?>"/>
				</li>
				<li>
					<label for="map_center_lng"><?php _e( 'Center Longitude', 'hugeit_maps' ); ?></label>
					<input type="text" name="map_center_lng" id="map_center_lng" value="<?php echo $map->get_center_lng(); ?>"/>
				</li>
				<li>
					<label for="map_width"><?php _e( 'Map Width', 'hugeit_maps' ); ?></label>
					<div class="slider-container" style="float:left; width:55%; height:25px; ">
				...
				<li>
					<label for="map_height"><?php _e( 'Map Height', 'hugeit_maps' ); ?></label>
					<input class="front_end_input_options" type="number" name="map_height" id="map_height"
					       value="<?php echo $map->get_height(); ?>"/>
				</li>
				<li>
					<label for="map_align"><?php _e( 'Map Align', 'hugeit_maps' ); ?></label>
					<select class="front_end_input_options" name="map_align" id="map_align">
						<option value="left" <?php selected( $map->get_align(), 'left' ); ?>><?php _e( 'left', 'hugeit_maps' ); ?></option>
						<option value="center" <?php selected( $map->get_align(), 'center' ); ?>><?php _e( 'center', 'hugeit_maps' ); ?></option>
						<option value="right" <?php selected( $map->get_align(), 'right' ); ?>><?php _e( 'right', 'hugeit_maps' ); ?></option>
					</select>
				</li>
				<li>
				...
				<li class="pro">
					<label for="map_infowindow_type"><?php _e( 'Marker Infowindow Opens On', 'hugeit_maps' ); ?></label>
					<select disabled id="map_infowindow_type" name="map_infowindow_type">
						<option value="click" <?php selected($map->get_info_type(), 'click' ); ?> ><?php _e( 'Click', 'hugeit_maps' ); ?></option>
						<option value="hover" <?php selected($map->get_info_type(), 'hover' ); ?> ><?php _e( 'Hover', 'hugeit_maps' ); ?></option>
					</select>
				</li>
				<li class="pro">
					<label for="wheel_scroll"><?php _e( 'Wheel Scrolling', 'hugeit_maps' ); ?></label>
					<select disabled class="front_end_input_options" name="wheel_scroll" id="wheel_scroll">
						<option value="1" <?php selected( $map->get_wheel_scroll(), 1 ); ?>><?php _e( 'On', 'hugeit_maps' ); ?></option>
						<option value="0" <?php selected( $map->get_wheel_scroll(), 0 ); ?>><?php _e( 'Off', 'hugeit_maps' ); ?></option>
					</select>
				</li>
				<li class="pro">
					<label for="map_draggable"><?php _e( 'Map Draggable', 'hugeit_maps' ); ?></label>
					<select disabled class="front_end_input_options" name="map_draggable" id="map_draggable">
						<option value="1" <?php selected( $map->get_draggable(), 1 ); ?>><?php _e( 'On', 'hugeit_maps' ); ?></option>
						<option value="0" <?php selected( $map->get_draggable(), 0 ); ?>><?php _e( 'Off', 'hugeit_maps' ); ?></option>
					</select>
				</li>
				<li class="pro">
					<label for="map_language"><?php _e( 'Map Language', 'hugeit_maps' ); ?></label>
				...
				<li class="pro">
					<label for="map_animation"><?php _e( 'Map Animation', 'hugeit_maps' ); ?></label>
					<select disabled id="map_animation" name="map_animation">
						<option value="none" <?php selected( $map->get_animation(), 'none' ); ?>><?php _e( 'None', 'hugeit_maps' ); ?></option>

						<?php

						$groups = array(
							'attention_seekers' => __( 'Attention Seekers', 'hugeit_maps' ),
							'bouncing_entrances' => __( 'Bouncing Entrances', 'hugeit_maps' ),
							'fading_entrances' => __( 'Fading Entrances', 'hugeit_maps' ),
							'flippers' => __( 'Flippers', 'hugeit_maps' ),
							'rotating_entrances' => __( 'Rotating Entrances', 'hugeit_maps' ),
							'sliding_entrances' => __( 'Sliding Entrances', 'hugeit_maps' ),
							'zooming_entrances' => __( 'Zooming Entrances', 'hugeit_maps' )
						);
