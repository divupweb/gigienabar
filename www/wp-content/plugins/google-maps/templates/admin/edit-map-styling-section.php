...
<li class="editing_section">
    ...
    <div class="edit_content map_options hide">
        <form action="" method="post">
            ...
            <input disabled type="submit" class="button-primary" id="styling_submit" name="styling_submit" value="<?php _e( 'Save', 'hugeit_maps' ); ?>"/>
            <input disabled type="button" class="button cancel_button" id="styling_set_default" value="<?php _e( 'Default', 'hugeit_maps' ); ?>"/>
        </form>
    </div>
</li>
