...
<div id="hg_gmaps_no_api_key_big_notice" class="error">
	<p class="hg_mui_heading"><?php _e( 'Attention!', 'hugeit_maps' ); ?></br><?php _e( 'Before you begin using Google Map plugin, please note that All Google Maps users now required to have an API key to function. You can read more about that', 'hugeit_maps' ); ?> <a href="https://googlegeodevelopers.blogspot.am/2016/06/building-for-scale-updates-to-google.html" target="_blank"><?php _e( 'here.', 'hugeit_maps' ); ?></a></p>
	<div><a class="hg_mui_btn hg_mui_btn_raised_blue" target="_blank" href="https://console.developers.google.com/flows/enableapi?apiid=maps_backend,geocoding_backend,directions_backend,distance_matrix_backend,elevation_backend,places_backend&keyType=CLIENT_SIDE&reusekey=true"><?php _e( 'Register for Google Maps API now', 'hugeit_maps' ); ?></a></div>
