...
<li class="editing_section">
    <div class="editing_heading">
        ...
        <?php _e( 'Polygons', 'hugeit_maps' ); ?>
        <div class="help">?
            <div class="help-block">
                <span class="pnt"></span>
                <p><?php _e( 'Bounded highlighted area on the map, showing the specific range, limited with geometric figure. Right click on the map to add point. Hold pressed and drag to move it. Left click to remove it.', 'hugeit_maps' ); ?></p>
            </div>
        </div>
    ...
    <div class="edit_content hide">
        <div id="g_map_polygone_options">
            <form action="" method="post">
                <a id="polygon_add_button" class="add_button clear" href="#">+<?php _e( 'Add New Polygon', 'hugeit_maps' ); ?></a>
                <div class="hidden_edit_content hide">
                    <a href="#" id="back_polygone" class="cancel left">◄ <?php _e( 'Back', 'hugeit_maps' ); ?></a>
                    <ul>
                        <li class="has_background">
                            <label for="polygone_name"><?php _e( 'Name', 'hugeit_maps' ); ?></label>
                            <input type="text" name="polygone_name" id="polygone_name"/>
                        </li>
                        <li class="description_container">
                            <label for="polygone_coords">data</label>
                            <textarea id="polygone_coords" class="polycoords" name="polygone_coords" readonly="readonly" placeholder="<?php _e( 'Right click on the map to add point. Hold pressed and drag to move it. Left click to remove it.', 'hugeit_maps' ); ?>"></textarea>
                        </li>
                        <li>
                            <label for="polygone_line_opacity"><?php _e( 'Line Transparency', 'hugeit_maps' ); ?></label>
                        ...
                        <li class="has_background">
                            <label for="polygone_line_color"><?php _e( 'Line Color', 'hugeit_maps' ); ?></label>
                            <input type="text" class="jscolor polygone_options_input" name="polygone_line_color" id="polygone_line_color" value="FF0F0F"/>
                        </li>
                        <li>
                            <label for="polygone_line_width"><?php _e( 'Line Width', 'hugeit_maps' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px;">
                        ...
                        <li class="has_background">
                            <label for="polygone_fill_opacity"><?php _e( 'Fill Transparency', 'hugeit_maps' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li>
                            <label for="polygone_fill_color"><?php _e( 'Fill Color', 'hugeit_maps' ); ?></label>
                            <input type="text" name="polygone_fill_color" id="polygone_fill_color"
                                   class="jscolor polygone_options_input" value="5DFF0D"/>
                        </li>
                        <li class="pro">
                            <label for="polygone_url"><?php _e( 'Link', 'hugeit_maps' ); ?></label>
                            <input disabled type="text" name="polygone_url" id="polygone_url" placeholder="http://"/>
                        </li>
                        <li class="pro">
                            <label for="hover_polygone_fill_opacity"><?php _e( 'On-Hover Fill Transparency', 'hugeit_maps' ); ?></label>
                        ...
                        <li class="pro">
                            <label for="hover_polygone_fill_color"><?php _e( 'On-Hover Fill Color', 'hugeit_maps' ); ?></label>
                        ...
                        <li class="pro">
                            <label for="hover_polygone_line_opacity"><?php _e( 'On-Hover Line Transparency', 'hugeit_maps' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li class="pro">
                            <label for="hover_polygone_line_color"><?php _e( 'On-Hover Line Color', 'hugeit_maps' ); ?></label>
                    ...
                    <div>
                        ...
                        <a href="#" id="cancel_polygone" class="cancel"><?php _e( 'Cancel', 'hugeit_maps' ); ?></a>
                    </div>
                </div>
            </form>
            <div id="polygone_edit_exist_section">
                ...
                if( $polygons ){
                    ...
                    echo "<p class='empty_polygon'>".__( 'You have 0 polygones on this map', 'hugeit_maps' ) ."</p>";
                }
                ?>
            </div>
            <form action="" method="post">
                ...
                <div class="update_list_item hide">
                    <a href="#" id="back_edit_polygone" class="cancel left">◄ <?php _e( 'Back', 'hugeit_maps' ); ?></a>
                    <ul>
                        <li class="has_background">
                            <label for="polygone_edit_name"><?php _e( 'Name', 'hugeit_maps' ); ?></label>
                        ...
                        <li>
                            <label for="polygone_edit_line_opacity"><?php _e( 'Line Transparency', 'hugeit_maps' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li class="has_background">
                            <label for="polygone_edit_line_color"><?php _e( 'Line Color', 'hugeit_maps' ); ?></label>
                            <input type="text" class="jscolor polygone_edit_options_input" name="polygone_edit_line_color"
                                   id="polygone_edit_line_color" value=""/>
                        </li>
                        <li>
                            <label for="polygone_edit_line_width"><?php _e( 'Line Width', 'hugeit_maps' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li class="has_background">
                            <label for="polygone_edit_fill_opacity"><?php _e( 'Fill Transparency', 'hugeit_maps' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li>
                            <label for="polygone_edit_fill_color"><?php _e( 'Fill Color', 'hugeit_maps' ); ?></label>
                            <input type="text" name="polygone_edit_fill_color" id="polygone_edit_fill_color"
                                   class="jscolor polygone_edit_options_input" value=""/>
                        </li>
                        <li class="pro">
                            <label for="polygone_edit_url"><?php _e( 'Link', 'hugeit_maps' ); ?></label>
                            <input disabled type="text" name="polygone_edit_url" id="polygone_edit_url" placeholder="http://"/>
                        </li>
                        <li class="pro">
                            <label for="hover_polygone_edit_fill_opacity"><?php _e( 'On-Hover Fill Transparency', 'hugeit_maps' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li class="pro">
                            <label for="hover_polygone_edit_fill_color"><?php _e( 'On-Hover Fill Color', 'hugeit_maps' ); ?></label>
                        ...
                        <li class="pro">
                            <label for="hover_polygone_edit_line_opacity"><?php _e( 'On-Hover Line Transparency', 'hugeit_maps' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li class="pro">
                            <label for="hover_polygone_edit_line_color"><?php _e( 'On-Hover Line Color', 'hugeit_maps' ); ?></label>
                    ...
                    <div>
                        ...
                        <input type="submit" class="button-primary" name="polygone_edit_submit" id="polygone_edit_submit"
                               value="<?php _e( 'Save', 'hugeit_maps' ); ?>"/>
                        <a href="#" id="cancel_edit_polygone" class="cancel"><?php _e( 'Cancel', 'hugeit_maps' ); ?></a>
                    </div>
                </div>
            </form>
        </div>
